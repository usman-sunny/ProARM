...
export class BulkActionMenuComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.subs.push(this.selectionSource.getSelectedCount().subscribe(count => {
            this.count.set(count);
            this.stupidDataService.updateCount(count);
        }));
        ...
        //console.log('dropdownConfig fizyyyyyyyy', this.dropdownConfig);
        //console.log('dropdownSmallConfig fizzzzzzy', this.dropdownSmallConfig);

        this.stupidDataService.setBulkActionsObject(this.dropdownConfig);
