...
export class ButtonGroupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        if (this.buttons?.collapsed && this.buttons?.collapsed[0]?.label == 'Delete' && this.buttons?.collapsed[1]?.label == 'Duplicate') {
            this.stupidData.setActionButtonsObject(this.buttons);
        }

        if (this.buttons?.expanded && this.buttons?.expanded[0]?.label == 'Save' && this.buttons?.expanded[1]?.label == 'Cancel') {
            this.stupidData.setSaveCancelButtonsObject(this.buttons);
        }

        //this.stupidData.setSaveCancelButtonsObject(this.buttons);

        //console.log('6754 config observale is listed below:');
        //console.log(this.config$);

        //console.log('6754 buttons array is listed below:');
        //console.log(this.buttons);

        //console.log('6754 dropdownConfig is listed below:');
