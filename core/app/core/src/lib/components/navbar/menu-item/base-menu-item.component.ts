...
export class BaseMenuItemComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.$imagePath = this.getImageLink(this.item.link.label);
    ...
    getImageLink(moduleName: string): string {
        return "../core/app/shell/src/themes/suite8/images/modules/" + moduleName + ".svg";
    }
}
