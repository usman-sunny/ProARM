...
export class ActionGroupMenuComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        // console.log('config$ is listed belowwwwwww:');
        // console.log(this.config$);
        // console.log('configState is listed belowwwwwww:');
        // console.log(this.configState);
        // console.log("actionContexttttttttttttttttttttt");
        // console.log(this.actionContext);
    }
