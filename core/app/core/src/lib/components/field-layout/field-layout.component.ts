...
export class FieldLayoutComponent extends BaseFieldGridComponent {
    ...
    ngOnInit(): void {
        ...
        this.stupidData.saveCancelButtonsObject$.subscribe(data => {
            this.saveCancelButton = data;
        });

        this.stupidData.saveButtonObject$.subscribe(data => {
            if (data.label == 'Save') {
    ...
    buildGrid(): void {
        ...
        //console.log('Final fieldGrid:', this.fieldGrid);
    }
