...
export class RecordComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.stupidData.object$.subscribe(navbar => {
            if (navbar) {
                this.navbar = navbar;
                //console.log('Navbar from stupid service in record component:', navbar);
            }
        });

        // actions buttons object from button-group.component to record.component
        this.stupidData.actionButtonsObject$.subscribe(value => {
            if (value) {
                this.actionButtons = value;
                //console.log('actionButtons value from stupid service in record component:', value);
            }
        });
    ...
    click(clickFucntion: Function): void {
        if (clickFucntion) {
            clickFucntion();
        }   
    }
