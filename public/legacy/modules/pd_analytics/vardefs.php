...
$dictionary['pd_analytics'] = array(
    ...
    'fields' => array (
        ...
        // One-to-Many relation between pd_analytics and pd_collections - this (pd_analytics) is the one side
...
VardefManager::createVardef('pd_analytics', 'pd_analytics', array('basic','assignable','security_groups'));
