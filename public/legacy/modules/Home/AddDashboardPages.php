...
if (!isset($_POST['dashName'])) {
    ...
    $html .='<td style="width:100%;"><div class="row"><div class="col-md-12 col-sm-12 col-lg-12"><label for="dashName">'.$GLOBALS['app_strings']['LBL_ENTER_DASHBOARD_NAME'].'</label></div>';
    $html .='<div class="col-md-12 col-sm-12 col-lg-12"> <input type="text" name="dashName" id="dashName" style="width:100%;border: 1px solid #E0E6ED; color:#888EA8"/> </div> </div></td>';
    $html .='</tr>';
    $html .='<tr style="width:100%;">';
    $html .='<td style="width:100%;"><div class="row"><div class="col-md-12 col-sm-12 col-lg-12"><label for="numColumns">'.$GLOBALS['app_strings']['LBL_NUMBER_OF_COLUMNS'].' </label></div>';
    $html .='<div class="col-md-12 col-sm-12 col-lg-12"><select  style="width:100%; max-width:100%; margin-top:unset; border: 1px solid #E0E6ED; color:#888EA8" name="numColumns">';
