 ...
 */
*}
<div id="dashletSearch" style="width:100%;">
	<table style="width:100%;">
		<tr>
			<td>
			<div class="row">
			<div class="col-md-10 col-lg-10 col-sm-10">
			<input style="width:85%;" placeholder="Search SuiteCRM Dashlet" id="search_string" type="text" length="15" onKeyPress="javascript:if(event.keyCode==13)SUGAR.mySugar.searchDashlets(this.value,document.getElementById('search_category').value);"  title="{sugar_translate label='LBL_DASHLET_SEARCH' module='Home'}"/>
			<input style="float:right;" type="button" class="button" value="{sugar_translate label='LBL_SEARCH' module='Home'}" onClick="javascript:SUGAR.mySugar.searchDashlets(document.getElementById('search_string').value,document.getElementById('search_category').value);" />
			</div>
...
<div id="webDashlets" style="height:400px;display:none;">
	...
	<table width="95%">
	    <tr>
	        <td scope="row">
				<div class="row"> 
					<div class="col-md-12 col-lg-12 col-xl-12">{sugar_translate label='LBL_WEBSITE_TITLE' module='Home'}</div>
					<div class="col-md-12 col-lg-12 col-xl-12">
						<input type="text" id="web_address" value="http://" style="width: 89%; border: 1px solid #E0E6ED; color:#888EA8;"   title="{sugar_translate label='LBL_WEBSITE_TITLE' module='Home'}"/>
		...
		<tr>
			<td scope="row">
				<div class="row"> 
					<div class="col-md-12 col-lg-12 col-xl-12">{sugar_translate label='LBL_RSS_TITLE' module='Home'}</div>
					<div class="col-md-12 col-lg-12 col-xl-12">
						<input type="text" id="rss_address" value="http://" style="width: 89%; border: 1px solid #E0E6ED; color:#888EA8"  title="{sugar_translate label='LBL_RSS_TITLE' module='Home'}" />
