    ...
    <ul class="nav nav-tabs nav-dashboard">
        ...
        {if !$lock_homepage}
            <li id="tab-actions" class="dropdown">
                <a class="dropdown-toggle cstm-no-transform" data-toggle="dropdown" href="#">Actions<img src="themes/{$theme}/images/cstm-down-arrow.png" alt="Arrow" style="padding-left:8px;"></a>
